...
activities = {
    ...
    "Swimming Team": {
        "description": "Swim workouts and team competitions for all levels",
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and theater productions for students",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
    ...
    "Debate Team": {
        "description": "Study current events and practice public speaking and debate",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
